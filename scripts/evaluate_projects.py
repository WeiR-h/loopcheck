...
def main():
    ...
    manifest = ROOT/'docs/evidence/v052-frozen-cases.json'
    ...
    report={'version':'0.5.2','frozen_manifest_sha256':hashlib.sha256(manifest.read_bytes()).hexdigest(),
    ...
    (ROOT/'docs/evidence/v052-benchmark.json').write_text(json.dumps(report,ensure_ascii=False,indent=2),encoding='utf-8')
