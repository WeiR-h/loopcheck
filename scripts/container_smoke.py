...
def main():
    ...
    try:
        ...
        report={'version':'0.5.1','status':'passed','scope':'Fresh Linux Docker build, public-mode boundaries, three real browser flows across baseline/injected-fault/restoration',
        ...
        (ROOT/'docs/evidence/v051-container-check.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
        docker('rm','-f',NAME)
